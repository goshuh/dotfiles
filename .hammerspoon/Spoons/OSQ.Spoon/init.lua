    ...
    elseif #s > 0 then
      ...
      if ok and ret and ret.m == 'qsd' then
        ...
        if p.s == 'ok' then
          ...
          s.price   = p.v.lp  and p.v.lp  or p.v.rtc  and p.v.rtc  or s.price
          s.change  = p.v.ch  and p.v.ch  or p.v.rch  and p.v.rch  or s.change
          s.percent = p.v.chp and p.v.chp or p.v.rchp and p.v.rchp or s.percent
